...
//REVIEW:END
  ...
  CMatrix<C_FLOAT64> scaledHessian;
  ...
  for (i = 0; i < mVariableSize; i++)
    ...
    for (j = 0; j < mVariableSize; j++)
      std::cout << mHessian[i][j] << "\t";
    std::cout << std::endl;
    }
  std::cout << std::endl;

  //scaled Hessian
  std::cout << "scaled FIM: " << std::endl;
  scaledHessian = mHessian;
  for (i = 0; i < mVariableSize; i++)
  {
    for (j = 0; j < mVariableSize; j++)
    {
      scaledHessian[i][j] = mHessian[i][j]*mCurrent[i]*mCurrent[j];
      std::cout << scaledHessian[i][j] << "\t";
    }
    std::cout << std::endl;
  }
  std::cout << std::endl;
  ...
  std::cout << std::endl;
  std::cout << "Eigenvalues of scaled FIM:" << std::endl;
  for (i = 0; i < mVariableSize; i++)
  {
    std::cout << ev[i] << "\t";
  }
  ...
  std::cout << std::endl;
  std::cout << "Eigenvectors of scaled FIM: " << std::endl;
  for (i = 0; i < mVariableSize; i++)
  {
    for (j = 0; j < mVariableSize; j++)
      std::cout << A[i][j] << "\t";
