  ...
  for (mGeneration = 2;
       ...
       mGeneration++, Stalled++, Stalled10++, Stalled30++, Stalled50++)
    {
      ...
      if (Stalled > 50 && Stalled50 > 50)
        {
          if (mLogVerbosity >= 1) mMethodLog.enterLogItem(COptLogItem(COptLogItem::GASR_fittest_not_changed_x_random_generated).iter(mGeneration).with(Stalled50 - 1).with(50));
        ...
        {
          if (mLogVerbosity >= 1) mMethodLog.enterLogItem(COptLogItem(COptLogItem::GASR_fittest_not_changed_x_random_generated).iter(mGeneration).with(Stalled50 - 1).with(30));
        ...
        {
          if (mLogVerbosity >= 1) mMethodLog.enterLogItem(COptLogItem(COptLogItem::GASR_fittest_not_changed_x_random_generated).iter(mGeneration).with(Stalled50 - 1).with(10));
